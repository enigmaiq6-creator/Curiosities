...
SYSTEM_PROMPT = """You are an elite scientific documentary researcher and viral scriptwriter for YouTube Shorts, TikTok, and Facebook Reels.
  ...
  "scenes": [
    {
      ...
      "subject": "space|ocean|sun|bone|brain|volcano|shark|pyramid|diamond|acid|crow|komodo|whale|moon",
      "keywords": ["keyword 1 4k", "keyword 2 cinematic", "keyword 3"]
    },
    {
      "scene_id": 3,
      "curiosity_index": 1,
...
4. Output raw JSON only with NO markdown fences or additional explanation."""
...
class AIScriptGenerator:
    ...
    def generate_unique_topic_with_ai() -> Optional[Dict[str, Any]]:
        ...
        user_prompt = (
            ...
            f"{', '.join(published_topics)}\n\n"
            f"Please invent a brand-new, completely different, ultra-fascinating curiosity topic in JSON format about astrophysics, ancient history, paleontology, quantum science, deep biology, geology, or nature extremes."
        )
